...
**front end
 npm run dev(running next.js)
**backend on sanity
npx @sanity/cli init(installing sanity and creating databae)
npx @sanity/cli manage(oppening ur sanity database)
npx @sanity/cli start(running the backend server on sanity_ecc..).
